...
if __name__ == "__main__":
    # 输入输出路径配置
    input_file1 = "/root/MDIplier/header_results/s7comm_100.out"  # 文件1路径
    input_file2 = "/root/MDIplier/body_results/s7comm_100.out" # 文件2路径
    output_dir = "/root/MDIplier/body_results/"            # 输出目录
    output_file = f"{output_dir}n_s7comm_100.out"  
