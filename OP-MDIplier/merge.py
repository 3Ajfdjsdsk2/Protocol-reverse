...
if __name__ == "__main__":
    # 输入输出路径配置
    input_file1 = "/root/MDIplier/op_hres/cip_50.out"  # 文件1路径
    input_file2 = "/root/MDIplier/op_bores/n_cip_50.out" # 文件2路径
    output_dir = "/root/MDIplier/app_res/"            # 输出目录
    output_file = f"{output_dir}1.out"           # 输出文件路径
